...
export default function ShopHistoryWeb() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel(`web-shop-history-${shopId}`)
      .on('postgres_changes', { event: '*', schema: 'public', table: 'orders', filter: `shop_id=eq.${shopId}` }, fetchHistory)
      .subscribe();
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={s.statsRow}>
        {[
          ...
          { label: 'Ακυρώθηκαν', value: cancelled, color: '#EF4444' },
        ].map(stat => (
              ...
              <tr>
                <td colSpan={8} style={{ ...s.td, textAlign: 'center', padding: 52 }}>
                  <p style={{ color: colors.textSecondary, margin: 0 }}>
                    Δεν υπάρχουν παραγγελίες τις τελευταίες 24 ώρες
                  </p>
                </td>
              </tr>
            ) : (
